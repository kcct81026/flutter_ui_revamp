...
final List<FeedItemModel> dummyFeedItems = [
  FeedItemModel(
    ...
    text: "landscape 5 +  ",
    images: [landscapeURL, mediaURL1, mediaURL3, mediaURL5, mediaURL6],
    likes: 12,
    comments: 3,
  ),
  FeedItemModel(
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "portrait 2  ",
    images: [portraitURL, landscapeURL],
    likes: 12,
    comments: 3,
  ),
  FeedItemModel(
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "landscape 3 ",
    images: [landscapeURL, mediaURL1, squareURL],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "square 3  ",
    images: [squareURL, mediaURL1, mediaURL4],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "landscape 4  ",
    images: [landscapeURL, mediaURL1, mediaURL3, mediaURL5],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "portrait 4  ",
    images: [portraitURL, landscapeURL, mediaURL1, mediaURL8],
    likes: 12,
    comments: 3,
  ),
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "square 4  ",
    images: [squareURL, mediaURL1, mediaURL4, mediaURL5],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "landscape  ",
    images: [landscapeURL, mediaURL1, mediaURL3, squareURL, mediaURL1],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "Team, please check today’s sales summary.  ",
    images: [squareURL, mediaURL1, mediaURL1],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "Team, please check today’s sales summary.  ",
    images: [portraitURL, landscapeURL, squareURL],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    text:
        "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).",
    images: [portraitURL, mediaURL7, mediaURL1, mediaURL4],
    likes: 12,
    comments: 3,
  ),
  FeedItemModel(
    ...
    text:
        "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).",
    images: [landscapeURL, mediaURL8, mediaURL1, mediaURL4],
    likes: 12,
    comments: 3,
  ),
  FeedItemModel(
