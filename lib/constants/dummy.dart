final List<FeedItemModel> dummyFeedItems = [
  ...
  FeedItemModel(
    ...
    promotionText: "Promotion",
    text: "Three image landscape",
    images: [mediaURL7, mediaURL8, mediaURL1],
    likes: 12,
    comments: 3,
  ),
  ...
  FeedItemModel(
    ...
    isPromoted: true,
    promotionText: "Promotion",
    text: "Three image portrait",
    images: [mediaURL8, mediaURL1, mediaURL7],
    likes: 12,
    comments: 3,
  ),
