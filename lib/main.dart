...
import 'package:yc_ui/videoplayer_poc/feed_screen.dart';
...
void main() {
  ...
  //     if (totalTime > 16) {
  //       debugPrint(
  //         " Slow frame: build=${buildTime}ms, raster=${rasterTime}ms, total=${totalTime}ms",
  //       );
  //     }
  //   }
  // });
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SocialFeedScreen(items: generateFeed(100)),
